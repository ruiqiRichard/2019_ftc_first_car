...
public class RobotMapSecond {
    ...
    public static DcMotor handFoward = null;
    public static DcMotor handBackward = null;
    public static Servo locker = null;
...
//    public static final double lockerInitPosition = 0.0;
//    public static final double lockerLocked = 0.0;
//    public static final double lockerUnLocked = 0.0;
    ...
    public void robotInit(HardwareMap hardwareMap){
        ...
        this.locker = hwmap.servo.get("locker");
        this.handFoward = hwmap.dcMotor.get("forwardhand");
        this.handBackward = hwmap.dcMotor.get("backwardhand");
...
//            Arrays.fill(leftMotorOutput, zRotation);
//            Arrays.fill(rightMotorOutput, zRotation);
//        }
//
//        else if (zRotation < 0.0){
//            Arrays.fill(leftMotorOutput, -zRotation);
